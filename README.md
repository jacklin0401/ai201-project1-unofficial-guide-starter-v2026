...
**Chunk size:** One document per chunk
**Overlap:** None
...
I chose to keep each document as one chunk because the `campus_life` documents are generally short and focused on a single topic. Splitting these documents further could separate information that belongs together and make the chunks less useful for retrieval.
